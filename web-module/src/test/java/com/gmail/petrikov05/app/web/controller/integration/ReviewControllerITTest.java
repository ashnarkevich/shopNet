...
import static com.gmail.petrikov05.app.web.controller.constant.TestUserConstant.VALID_REVIEW_AUTHOR;
...
class ReviewControllerITTest {
    ...
    public void showReviewsPage_returnReviewsWithPagination() throws Exception {
        ...
        assertThat(actualContent).contains(VALID_REVIEW_AUTHOR);
